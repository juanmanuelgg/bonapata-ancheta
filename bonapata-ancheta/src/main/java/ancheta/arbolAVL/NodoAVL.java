		...
		if( diferencia <= -1)
		{
			...
			if( diferencia < -1)
			{
				if(hijosEnFormaL())
				{
					...
					//Se declara la variable blanco para que los programadores no se vuelen la tusta
					...
					//dado que rojo y azul rey pueden ser nulos se atrapan posibles null pointer; de manera separarda
					try{
